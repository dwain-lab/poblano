                    ...
                    <td>
                            ...
                            @method('DELETE')
                                {!! Form::button('<i class="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                  ...
                                  </svg></i>', ['type' => 'submit', 'onclick' => 'return confirm(\'Are you sure you want to delete: '. $menu_category->heading.'?\')', 'style' => 'border: none; background-color:transparent;', 'title'=>'Delete']) !!}
                            {!! Form::close() !!}
                    </td>
                </tr>
            @endforeach
