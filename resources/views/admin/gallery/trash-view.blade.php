    ...
    @section('content')
        ...
        <div class="container position-relative text-lg-left aos-init aos-animate">
            ...
            <div style="padding-top:3%">
                ...
                <a class="btn btn-primary" href="{{ route('gallery.create') }}" title="Add New"
                ...
                <a class="btn btn-primary" href="{{ route('gallery.index') }}" title="Go Back"
                ...
                @foreach ($galleries as $gallery)
                    <tr>
                        ...
                        <td style="text-align: center;"> <img
                                src="{{ File::exists($gallery->getFirstMediaPath('gallery-collection', 'thumb')) ? $gallery->getFirstMediaUrl('gallery-collection', 'thumb') : 'https://via.placeholder.com/270x180.jpg?text=No+Image' }}">
                        </td>
                        <td>
                            <div class="row">
                                ...
                                $gallery->name . '?\')', 'style' => 'border: none; background-color:transparent;', 'title'
