                ...
                @foreach ($galleries as $gallery)
                    <tr>
                        ...
                        <td style="text-align: center;"> <img
                                src="{{ File::exists($gallery->getFirstMediaPath('gallery-collection', 'thumb')) ? $gallery->getFirstMediaUrl('gallery-collection', 'thumb') : 'https://via.placeholder.com/270x180.jpg?text=Upload+an+image' }}">
                        </td>
                        <td>
                            {!! Form::open(['route' => ['gallery.destroy', $gallery->id], 'method' => 'post']) !!}
                            {{-- <a href="{{ route('phone.show', $phone->id) }}" title="show"
                                class="crud-spacing">
                                <i class="fas fa-eye text-success  fa-lg"></i>
                            </a> --}}
                            <a href="{{ route('gallery.edit', $gallery->id) }}" class="crud-spacing" title="Edit">
