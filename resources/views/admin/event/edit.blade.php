...
<div class="container position-relative text-lg-left aos-init aos-animate">
    ...
    <div style="padding-top:3%">
        ...
        <a class="btn btn-primary" href="{{ route('event.create') }}" title="Add New" style="background-color: rgb(136, 101, 42); hover:opacity:30%"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
        ...
        <a class="btn btn-primary" href="{{ route('event.index') }}" title="Go Back" style="background-color: rgb(136, 101, 42)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-backspace-fill" viewBox="0 0 16 16">
    ...
    @endif
    {!! Form::open(['route' => ['event.update', $event->id], 'method' => 'patch', 'files' => 'true']) !!}

        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('heading', 'Heading') !!}</strong>
                    {!! Form::text('heading', $event->heading, ['placeholder'=>'Enter a heading', 'class'=>'form-control', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('cost', 'Price') !!}</strong>
                    {!! Form::text('cost', $event->cost, ['placeholder'=>'Enter a price', 'class'=>'form-control', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('intro', 'Introduction') !!}</strong>
                    {!! Form::textarea('intro', $event->intro, ['placeholder'=>'Enter an Introduction', 'class'=>'form-control tinyeditor', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('point1', 'Point 1') !!}</strong>
                    {!! Form::text('point1', $event->point1, ['placeholder'=>'Enter a point', 'class'=>'form-control', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('point2', 'Point 2') !!}</strong>
                    {!! Form::text('point2', $event->point2, ['placeholder'=>'Enter a point', 'class'=>'form-control', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('point3', 'Point 3') !!}</strong>
                    {!! Form::text('point3', $event->point3, ['placeholder'=>'Enter a point', 'class'=>'form-control', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('end', 'Conclusion') !!}</strong>
                    {!! Form::textarea('end', $event->end, ['placeholder'=>'Enter a conclusion', 'class'=>'form-control tinyeditor', 'spellcheck'=>'true']) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
