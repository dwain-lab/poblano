        ...
        <div class="container">
            ...
            <table class="table table-bordered table-responsive-lg" style="overflow-x: auto">
                ...
                @foreach ($events as $event)
                    <tr>
                        <td>{{ Str::limit($event->heading, 30) }}</td>
                        <td>{{ $event->cost }}</td>
                        <td>{!! Str::limit(html_entity_decode($event->intro), 40) !!}</td>
                        <td>{{ Str::limit($event->point1, 30) }}</td>
                        <td>{{ Str::limit($event->point2, 30) }}</td>
                        ...
                        <td style="padding: 0%">
                            <div class="row" style="margin-left: auto">
                                ...
                                <a href="{{ route('event.edit', $event->id) }}" class="crud-spacing" title="Edit">
                                ...
                                [
                                'type' => 'submit',
                                'onclick' => 'return confirm(\'Are you sure you want to delete: ' . $event->heading .
                                '?\')',
