...
@section('content')
    ...
    <div class="container position-relative text-lg-left aos-init aos-animate">
        ...
        {!! Form::open(['route' => 'event.store', 'method' => 'post', 'files' => true, 'id' => 'createForm']) !!}
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    ($errors->has('point1') ? ' is-invalid' : null), 'spellcheck' => 'true', $errors->has('point1') ?
                    'autofocus' : null]) !!}
                    @error('point1')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    ($errors->has('point2') ? ' is-invalid' : null), 'spellcheck' => 'true', $errors->has('point2') ?
                    'autofocus' : null]) !!}
                    @error('point2')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    ($errors->has('point3') ? ' is-invalid' : null), 'spellcheck' => 'true', $errors->has('point3') ?
                    'autofocus' : null]) !!}
                    @error('point3')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
