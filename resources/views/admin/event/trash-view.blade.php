                ...
                @foreach ($events as $event)
                    <tr>
                        ...
                        <td style="text-align: center;"> <img
                                src="{{ File::exists($event->getFirstMediaPath('event-collection', 'thumb')) ? $event->getFirstMediaUrl('event-collection', 'thumb') : 'https://via.placeholder.com/270x180.jpg?text=No+image' }}">
                        </td>
                        ...
                        <td style="padding-top: 8px; padding-left: 0; padding-right:0">
                            <div class="row" style="margin-left: auto">
                                ...
                                {!! Form::button(
                                '<i class="text-success"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                ...
                                ['type' => 'submit', 'onclick' => 'return confirm(\'Are you sure you want to restore: ' .
                                $event->heading . '?\')', 'style' => 'border: none; background-color:transparent;', 'title'
                                => 'Restore', 'class' => 'crud_spacing'],
                                ) !!}
                                {!! Form::close() !!}
                                ...
                                $event->heading . '?\')', 'style' => 'border: none; background-color:transparent;', 'title'
                                => 'Permanently Delete', 'class' => 'crud_spacing'],
                                ) !!}
                                {!! Form::close() !!}
                            </div>
                        </td>
