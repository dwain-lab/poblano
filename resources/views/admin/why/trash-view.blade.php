    ...
    @section('content')
        ...
        <div class="container position-relative text-lg-left aos-init aos-animate">
            ...
            <div style="padding-top:3%">
                ...
                <a class="btn btn-primary" href="{{ route('why.create') }}" title="Add New"
                ...
                <a class="btn btn-primary" href="{{ route('why.index') }}" title="Go Back"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                ...
                                $why->heading . '?\')', 'style' => 'border: none; background-color:transparent;', 'title' =>
