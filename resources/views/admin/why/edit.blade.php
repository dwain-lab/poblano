...
<div class="container position-relative text-lg-left aos-init aos-animate">
    ...
    @endif
    {!! Form::open(['route' => ['why.update', $why->id], 'method' => 'patch', 'files' => 'true']) !!}

    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>{!! Form::label('heading', '*Heading') !!}</strong>
                {!! Form::text('heading', $why->heading, ['placeholder'=>'Enter a Heading', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('heading')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('content', $why->content, ['placeholder'=>'Enter a Content', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('content')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
