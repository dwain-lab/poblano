...
@section('content')
    ...
    <div class="container position-relative text-lg-left aos-init aos-animate">
        ...
        {{-- <div class="search-inline" style="width: 100%; display:grid">
            ...
            {!! Form::close() !!} --}}
            {{-- </div> --}}
        {!! Form::open(['route' => ['why.update', $why->id], 'method' => 'patch', 'files' => 'true', 'id' => 'editForm'])
        !!}
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('heading', $why->heading, ['placeholder' => 'Enter a Heading', 'class' => 'form-control '
                    . ($errors->has('heading') ? ' is-invalid' : null), 'spellcheck' => 'true', $errors->has('heading') ?
                    'autofocus' : null]) !!}
                    @error('heading')
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('content', $why->content, ['placeholder' => 'Enter a Content', 'class' =>
                    'form-control']) !!}
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
