        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('content', null, ['placeholder' => 'Enter a Content', 'class' => 'form-control', 'id'
                    => 'content']) !!}
                    @error('content')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                    {!! Form::button('Save', ['type' => 'submit', 'class' => 'btn btn-primary', 'style' =>
                    'background-color: rgb(136, 101, 42); margin:20px;', 'title' => 'Save']) !!}
                </div>
            </div>
        </div>
        {!! Form::close() !!}
