            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('dish', null, ['placeholder'=>'Enter a Dish Name', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                        @error('dish')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('cost', null, ['placeholder'=>'Enter a price', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                        @error('cost')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('ingredients', null, ['placeholder'=>'Enter an Ingredients', 'class'=>'form-control', 'spellcheck'=>'true'], 'required') !!}
                        @error('ingredients')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
