                ...
                @foreach ($menus as $menu)
                    <tr>
                        ...
                        <td style="text-align: center;"> <img
                                src="{{ File::exists($menu->getFirstMediaPath('menus-collection', 'thumb')) ? $menu->getFirstMediaUrl('menus-collection', 'thumb') : 'https://via.placeholder.com/270x180.jpg?text=No+image' }}">
                        </td>
                        ...
                        <td>
                            <div class="row">
                                ...
                                $menu->dish . '?\')', 'style' => 'border: none; background-color:transparent;', 'title' =>
