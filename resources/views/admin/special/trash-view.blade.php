                ...
                @foreach ($specials as $special)
                    <tr>
                        ...
                        <td style="text-align: center;"> <img
                                 src="{{ $special->getFirstMediaUrl('specials-collection', 'thumb') }}"> </td>
                        ...
                        <td>
                            <div class="row">
                                ...
                                {{-- <a href="{{ route('special.edit', $special->id) }}"
                                   class="crud-spacing">
                                    <i class="text-warning"><svg xmlns="http://www.w3.org/2000/svg"
                                             width="25"
                                             height="25"
                                             fill="currentColor"
                                ...
                                $special->link . '?\')', 'style' => 'border: none; background-color:transparent;', 'title'
