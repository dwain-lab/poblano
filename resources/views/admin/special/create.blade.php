...
@section('content')
    ...
    <div class="container position-relative text-lg-left aos-init aos-animate">
        ...
        {!! Form::open(['route' => 'special.store', 'method' => 'post', 'files' => true, 'id' => 'specialCreateForm']) !!}
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{!! Form::label('link', '*Dish Name') !!}</strong>
                    {!! Form::text('link', null, ['placeholder' => 'Enter a Dish Name', 'class' => 'form-control ' .
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    ($errors->has('heading') ? ' is-invalid' : null), $errors->has('heading') ? 'autofocus' : null,
                    'spellcheck' => 'true']) !!}
                    @error('heading')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('end', null, ['placeholder' => 'Enter an Conclusion', 'class' => 'form-control']) !!}
                    @error('end')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
