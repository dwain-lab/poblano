        ...
        <div class="container">
            ...
            <table class="table table-bordered table-responsive-lg">
                ...
                @foreach ($specials as $special)
                    <tr>
                        <td> {{ Str::limit($special->link, 30) }} </td>
                        <td> {{ Str::limit($special->heading, 30) }} </td>
                        <td> {!! Str::limit(html_entity_decode($special->intro), 40) !!} </td>
                        <td> {!! Str::limit(html_entity_decode($special->end), 40) !!} </td>
                        ...
                        <td style="padding: 0%">
                            <div class="row" style="margin-left: auto">
                                ...
                                <a href="{{ route('special.edit', $special->id) }}" class="crud-spacing" title="Edit">
                                ...
                                $special->heading . '?\')', 'style' => 'border: none; background-color:transparent;',
                                'title' => 'Delete'],
                                ) !!}
                                {!! Form::close() !!}
                            </div>
