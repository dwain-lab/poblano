    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('link', $special->link, ['placeholder'=>'Enter a Dish Name', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('link')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('heading', $special->heading, ['placeholder'=>'Enter a Heading', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('heading')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('intro', $special->intro, ['placeholder'=>'Enter an Introduction', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('intro')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('end', $special->end, ['placeholder'=>'Enter an Conclusion', 'class'=>'form-control', 'spellcheck'=>'true', 'required']) !!}
                @error('end')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
