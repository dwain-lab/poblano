        ...
        <div class="container">
            ...
            <table class="table table-bordered table-responsive-lg" style="overflow-x: auto">
                ...
                @foreach ($abouts as $about)
                    <tr>
                        <td>{{ $about->heading }}</td>
                        <td>{!! Str::limit($about->intro, 50) !!}</td>
                        <td>{{ Str::limit($about->point1, 40) }}</td>
                        <td>{{ Str::limit($about->point2, 40) }}</td>
                        <td>{{ Str::limit($about->point3, 40) }}</td>
                        <td>{!! Str::limit($about->end, 50) !!}</td>
                        ...
                        <td style="padding-left: 0%;">
                            ...
                            <a href="{{ route('about.edit', $about->id) }}" class="crud-spacing" title="Edit">
