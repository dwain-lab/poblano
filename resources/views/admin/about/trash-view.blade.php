    ...
    @section('content')
        ...
        <div class="container position-relative text-lg-left aos-init aos-animate">
            ...
            <div style="padding-top:3%">
                ...
                <a class="btn btn-primary" href="{{ route('about.create') }}" title="Add New"
                ...
                <a class="btn btn-primary" href="{{ route('about.index') }}" title="Go Back"
                ...
                @foreach ($abouts as $about)
                    <tr>
                        ...
                        <td style="padding-left: 0%;">
                            <div class="row">
                                {!! Form::open(['route' => ['about.trashRestore', $about], 'method' => 'put']) !!}
                                ...
                                $about->heading . '?\')', 'style' => 'border: none; background-color:transparent;', 'title'
                                => 'Restore', 'class' => 'crud_spacing'],
                                ) !!}
                                {!! Form::close() !!}

                                {!! Form::open(['route' => ['about.trashDestroy', $about], 'method' => 'delete']) !!}
                                {!! Form::button(
