                    ...
                    @foreach ($specials as $special)
                        <li class="nav-item">
                            @if ($special->id == $specialFirst)
                                <a class="nav-link active show" data-toggle="tab" href="#tab-{{ $special->id }} ">
                                    {{ $special->link }} </a>
                            @else
                                <a class="nav-link" data-toggle="tab" href="#tab-{{ $special->id }} ">
                                    {{ $special->link }} </a>
                            @endif
                        </li>
                    @endforeach
                                ...
                                <div class="tab-pane" id="tab-{{ $special->id }}">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src=" {{ $special->getFirstMediaUrl('specials-collection', 'gallery') }} "
                                                alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
